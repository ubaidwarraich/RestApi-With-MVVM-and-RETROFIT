...
public class HorizantalDottedProgress extends View {
    //actual dot radius
    ...
    public HorizantalDottedProgress(Context context) {
        super(context);
    }

    public HorizantalDottedProgress(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HorizantalDottedProgress(Context context, AttributeSet attrs, int defStyleAttr) {
